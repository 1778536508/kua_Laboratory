...
var config = {
    ...
    header: {
        0: {text: "首页", value: "home.html"},
        1: {text: "案例", value: "example.html"},
        2: {text: "K + 孵化器", value: "Incubator.html"},
        3: {text: "合作方式", value: "formmode.html"},
        4: {text: "我们", value: "aboutUs.html"}
    },
    footer: {
    ...
    isImgLoad(function() {
        ...
        function btnDetails() {
            $("#Incubator-nov-img-box li").click(function () {
                window.location.href = "http://" + window.location.host + "/dist/details.html?id=" + $(this).attr('data_id') + "&list=" + $(this).attr('data_list');
            })
        }
